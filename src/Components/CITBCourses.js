// src/components/CITBCourses.js
import React from "react";
 import "../Css/ServicePage.css"; // Make sure to style your component
    ...
    <div className="service">
      <div className="container">
        <div className="section-header text-center">
          <p>Our CITB Courses</p>
          <h2>We Provide CITB Courses</h2>
        </div>
        <div className="row">
          {/* Course 1 */}
            ...
            <div className="service-item">
              <div className="service-img">
                ...
                <div className="service-overlay">
                  <p>
                    Learn about SMSTS, a CITB-accredited course focused on health and safety on construction sites.
                  </p>
                </div>
              </div>
              <div className="service-text">
                <h3>SMSTS</h3>
                <a className="btn" href="images/service-1.jpg" data-lightbox="service">
                  +
                </a>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div className="service-item">
              <div className="service-img">
                ...
                <div className="service-overlay">
                  <p>
                    SSSTS is another CITB-accredited course aimed at site supervisors to promote safety awareness.
                  </p>
                </div>
              </div>
              <div className="service-text">
                <h3>SSSTS</h3>
                <a className="btn" href="images/service-2.jpg" data-lightbox="service">
                  +
                </a>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div className="service-item">
              <div className="service-img">
                ...
                <div className="service-overlay">
                  <p>
                    Learn more about our architecture design courses and how they can enhance your career in the field.
                  </p>
                </div>
              </div>
              <div className="service-text">
                <h3>Architecture Design</h3>
                <a className="btn" href="images/service-3.jpg" data-lightbox="service">
                  +
                </a>
              </div>
            </div>
